...
def UpdateEncyclopedia():
    ...
    data_Dir = os.path.join(os.getcwd(), "Data", "MagnatesRealm")
    exchange_Dir = os.path.join(data_Dir, "Exchange")
    ...
    def CreateEntrepeneurVersions():
        ...
        entrepeneurResourcesPath = os.path.join(os.getcwd(), "Data", "EntrepreneursRealm", "Encyclopedia","Resources","Exchange_Resource_List.json")
